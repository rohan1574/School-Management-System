  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="bg-white shadow p-4 rounded-lg mb-6 flex justify-between items-center">
        <h1 className="text-xl font-bold text-gray-800">All Announcements</h1>
     ...
     <div className="bg-white shadow rounded-lg p-4">
        <div className="grid grid-cols-7 gap-4 text-gray-700 font-semibold border-b pb-2">
          {["name", "id", "subjects", "title", "phone", "address"].map((field) => (
            <div
              key={field}
      ...
      {isAddModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-6 rounded-lg w-96 shadow-lg">
            <h2 className="text-lg font-bold mb-4">Add Announcements</h2>
            <form
              onSubmit={(e) => {
                e.preventDefault();
